...
const Home = () => {
 ...
 const handleUpdateCompany = (e, index) => {
  ...
  const handleFormSubmit = (e) => {
    ...
    fetch.post('http://localhost:4000/resume/create', formData, {}).then((res) => {
      if(res.data.message) {
  ...
  // rendering the loading component you submit the form.
  if(loading) {
    return <h1><Loading/></h1>
  }
  return (
    <div className='app'>
      <h1>Asoh Yannick's Resume Builder</h1>
      ...
      <form onSubmit={handleFormSubmit} method='POST'
       encType='multipart/form-data'>
        ...
        <div className='nestedContainer'>
          ...
          <div>
            <label htmlFor='photo'>Upload your files image</label>
            <input 
             type='file'
             required
             name='photo'
             id='photo'
             accept='image/x-png, image/jpeg, image/svg'
        ...
        {companyInfo.map((company, index) => (
          <div className='nestedContainer' key={index}>
            ...
            <div className='btn__group'>
              {companyInfo.length -1 === index && companyInfo.length < 3 && (
